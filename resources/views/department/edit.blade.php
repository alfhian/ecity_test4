...
<div class="h-100 float-end content">
	...
	<div class="container mt-3">
		...
		<form method="post" action="/department/edit/save">
			@csrf
			...
			<div class="row">
				<div class="col-md-12">
					<table class="w-100 input-table" cellpadding="5">
						@foreach($row as $rw)
						<input type="hidden" name="id" value="{{ $rw->id_dept }}">
						<tr>
							<td>
								<label for="nama_dept" class="pe-4">Nama Department</label>
								<input type="text" class="form-control" name="nama_dept" id="nama_dept" value="{{ $rw->nama_dept }}">
							</td>
						</tr>
						@endforeach
						<tr>
